...
const links = [
    {
        ...
        webSite: 'https://the-fighting-mongooses-official.github.io/Cards-Against-Apathy/'
    },
    {
        gitHub: 'https://github.com/5ynergy/bandwagon',
        webSite: 'https://bandwagon-official.herokuapp.com/'
    },
    {
        gitHub: 'https://github.com/TrilogyHi5/meal-train',
        webSite: 'https://meal-train.herokuapp.com/'
    }
]
...
function Portfolio() {
    ...
    { id: 3, title: 'Meal Train', description: 'A healthy eating app designed to plan daily balanced meals', image: mealTrain }]
    return (
